      ...
      >
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 flex-shrink-0">
          <div className="flex-1 min-w-0">
            <h2 id="support-panel-title" className="text-lg sm:text-xl font-bold text-gray-900 truncate">
              Karobot Support
            </h2>
          ...
          <button
            onClick={onClose}
            className="flex-shrink-0 ml-4 text-gray-500 hover:text-gray-700 p-2 rounded-lg hover:bg-gray-100 transition-colors"
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
          {messages.length === 0 && (
            <div className="text-center text-gray-500 mt-4 sm:mt-8 space-y-4 px-2">
              ...
              <p className="text-base sm:text-lg font-medium">Hi! I'm Karobot</p>
          ...
          {messages.map((message, index) => (
            ...
            >
              <div
                className={`max-w-[90%] sm:max-w-[85%] rounded-lg px-3 py-2 sm:px-4 sm:py-3 space-y-2 ${
                  message.role === 'user'
          ...
          {isLoading && (
            <div className="flex justify-start">
              <div className="bg-gray-100 rounded-lg px-3 py-2 sm:px-4 sm:py-3 flex items-center gap-2">
                <Spinner size="sm" />
        ...
        {/* Input */}
        <form onSubmit={handleSubmit} className="p-3 sm:p-4 border-t border-gray-200 bg-gray-50 flex-shrink-0">
